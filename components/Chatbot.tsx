                ...
                >
                  <div className={`flex gap-3 max-w-[85%] ${message.role === 'user' ? 'flex-row-reverse' : ''}`}>
                    <div className="w-8 h-8 mt-auto rounded-full flex-shrink-0 flex items-center justify-center glass bg-white/5 border border-white/10">
                      {message.role === 'user' ? <User className="w-4 h-4 text-blue-400" /> : <Bot className="w-4 h-4 text-amber-400" />}
                    </div>
                    ...
                    <div className="flex flex-col gap-1 w-full">
                      ...
                      <div
                        className={`px-4 py-3 text-sm leading-relaxed border border-white/5 shadow-lg ${
                          message.role === 'user'
            ...
            >
              <div className="relative flex items-center">
                <input
                  ...
                  className="w-full bg-[#050b14] border border-white/20 rounded-full pl-5 pr-12 py-3.5 text-sm text-white focus:outline-none focus:border-amber-500/50 focus:ring-1 focus:ring-amber-500/50 transition-all shadow-inner"
                />
                <button
                  type="submit"
